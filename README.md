...
A token is saved to localStorage to provide proof of authentication on future HTTP requests.

- [ ] What steps can you take in your web apps to keep your data secure?

Private routes can be set up to hide sensitive information until after a user has been authenticated, any request to those pages will redirect to the login page.

- [ ] Describe how web servers work.

Web servers are set up to listen for incoming requests to 'serve'. When a browser makes a request, the web server evaluates the request and returns the appropriate files for display on the browser.
